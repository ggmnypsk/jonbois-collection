...
!(function (t, e, i, s) {
      ...
      events: function (s) {
        ...
        a(this.scope)
          ...
          .on(
            ...
            "[" + this.attr_name() + "]",
            function (e) {
              var i = a(this).data(n.attr_name(!0) + "-init") || n.settings;
            ...
            .on(
              ...
              function (t) {
                if ((t.preventDefault(), !e.locked)) {
                  ...
                  if (((e.locked = !0), "undefined" == typeof n))
                    e.open.call(e, i);
                  else {
                    var o = n === !0 ? i.attr("href") : n;
    ...
    Foundation.libs.tooltip = {
      ...
      reposition: function (e, i, s) {
        ...
        i.css("visibility", "hidden").show(),
          ...
          this.small()
            ? i.css({ width: "100%" })
            : i.css({ width: n ? n : "auto" }),
          (l = function (t, e, i, s, n, a) {
            return t
              .css({
                top: e ? e : "auto",
                bottom: s ? s : "auto",
  ...
  function () {
    this.JST || (this.JST = {}),
      (this.JST["_templates/example"] = function (obj) {
        var __p = [];
        with (obj || {})
          __p.push(
            "<p>You should delete this example file</p>\n\n<h1>A sample ejs file</h1>\n\n<p>You can print javascript variables like so:</p>\n<p>My Variable = ",
            my_var,
            "\n<p>You can also use regular javascript there too:</p>\n<ul>\n"
          ),
            _.each(list, function (t) {
              __p.push("\n<li>", t, "</li>\n");
            }),
            __p.push(
              "\n</ul>\n\n<p>You can use this template in your app.js file like so:</p>\n<pre>\nvar template = window.JST['_templates/example'];\nvar html = template({my_var: 'Hello!', list: [1, 2, 3, 4]});\n$('#example').html(html);\n</pre>\n"
            );
        return __p.join("");
      });
  }.call(this),
  (function () {
    ...
    $(document).ready(function () {
      $(".lazy").lazyload({
        ...
        "true" == localStorage.getItem("pageExploded") ||
        window.location.href.indexOf("#") > -1
          ? ($(".article").addClass("not-explodey"),
            $("body").addClass("background"),
            localStorage.setItem("pageExploded", !0))
          : $(".article").addClass("explodey"),
        $(".explodey .primer").waypoint(
          function () {
            $(".text p").addClass("active"), setTimeout(t, 5500);
          },
          { offset: "160%" }
        ),
        $(document).keyup(function (t) {
          192 === t.keyCode && localStorage.setItem("pageExploded", !1);
        });
    });
  })();
